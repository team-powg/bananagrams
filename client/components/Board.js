            ...
            >
              ...
              >
                ...
                <button href={`/game/${this.props.createGame.currentGame}/winner`}
                  ...
                  disabled={this.props.createGame && this.props.createGame.players[player].playerPot && this.props.createGame.players[player].playerPot.some(tile => !tile.x) && this.props.createGame.pot.length > 3}
                >
                  Submit Game
                </button>
            </div>
